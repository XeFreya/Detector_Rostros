...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        if k == ord('s'):
            cv2.imwrite(f'Rostos encontrados/rostro_{count}.jpg',rostro)
            cv2.imshow('rostro',rostro)
            count += 1
    cv2.rectangle(frame,(10,5),(450,25),(255,255,255),-1)
    cv2.putText(frame,'Presione s para almacenar los rostros encontrados',(10,20),2,0.5,(128,0,255),2,cv2.LINE_AA)
